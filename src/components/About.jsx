  ...
  return (
    <section id="about" className="py-20 bg-white w-full">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          {/* Image Section */}
          <div data-aos="fade-right" className="w-full flex justify-center md:justify-start">
            <img src={about} alt="About Us" className="rounded-lg shadow-lg w-full max-w-md md:max-w-full" />
          </div>

          {/* Text Section */}
          <div data-aos="fade-left" className="w-full text-center md:text-left">
            <h3 className="text-2xl font-bold text-gray-900 mb-4">
              Who We Are
            </h3>
            <p className="text-gray-600 mb-6">
